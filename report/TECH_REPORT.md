...
> distinct line이 같은 set으로 false hit된다 — `/home/ramulator2/src/ramulator/frontend/impl/processor/simpleO3/llc.cpp:19-22`
...
```bash
# (0) 도구: Ramulator 2.1 @ /home/ramulator2 (python 3.10), llama.cpp build-kvtrace
# (1) 실측 캡처 → 전개 → 시뮬
